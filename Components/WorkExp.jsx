...
phones and desktops, along with web performance optimization for Single-page
applications.</li>
                <li>My major project is an <strong>HR Management Dashboard</strong> using ReactJS, NodeJS, and MongoDB. The dashboard includes various features such as employee management, attendance tracking, leave management, and performance reviews.</li>
            </ul><hr></hr>
        </div>
    );
};
